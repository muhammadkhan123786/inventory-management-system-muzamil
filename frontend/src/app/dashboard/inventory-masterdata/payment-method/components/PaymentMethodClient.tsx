...
import { CreditCard, Plus, Search, Loader2, LayoutGrid, Table2 } from "lucide-react";
...
export default function PaymentMethodClient() {
  ...
  const { 
    ...
    deleteItem, 
    updateItem 
  } = useFormActions<PaymentMethodWithId>(
    "/payment-method", 
    "paymentMethods", 
    "Payment Method", 
    currentPage, 
    ...
    <div className="min-h-screen ">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-linear-to-r from-blue-600 via-cyan-500 to-teal-600 rounded-2xl p-6 md:p-7 text-white shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-slideInLeft">
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <div className="flex-1 md:flex-none">
              ...
              <p className="text-blue-100 text-sm md:text-lg">Manage how you pay your suppliers</p>
            </div>
          </div>
          <button
        ...
        <StatsCards 
          ...
          icons={{ total: <CreditCard size={24} /> }}
        />
        ...
        <div className="bg-white p-5 pt-9 border-t-4! border-[#2B7FFF]! ">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-4 mb-6">
            <div className="space-y-1">
              <h2 className="text-2xl font-bold bg-linear-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Configuration & Listing</h2>
