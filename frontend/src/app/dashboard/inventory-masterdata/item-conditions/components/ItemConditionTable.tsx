...
interface TableProps {
    data: (IItemsConditions & { _id: string })[];
    displayView: "table" | "card";
    onEdit: (item: IItemsConditions & { _id: string }) => void;
    onDelete: (id: string) => void;
    onStatusChange?: (id: string, newStatus: boolean) => void;
    themeColor: string;
}

// Icon colors for different conditions
...
export default function ItemConditionTable({ data, displayView, onEdit, onDelete, onStatusChange, themeColor }: TableProps) {
    // Card View
    if (displayView === "card") {
        return (
                        ...
                        <div className="px-4 pb-4 space-y-3">
                            ...
                            <div className="pt-4">
                                <TableActionButton
                                    ...
                                    onDelete={() => {
                                        if (item.isDefault) {
                                            return toast.error("Default conditions cannot be deleted.");
                                        }
                                        onDelete(item._id);
                                    }}
                                />
