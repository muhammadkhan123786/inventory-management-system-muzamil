...
import { Receipt, Plus, Search, Loader2, LayoutGrid, Table2 } from "lucide-react";
...
export default function TaxClient() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const allDataRes = await getAll<TaxWithId>("/tax", {
          limit: "1000", 
