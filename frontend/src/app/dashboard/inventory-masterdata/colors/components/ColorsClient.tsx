...
import { Palette, Plus, Search, Loader2, LayoutGrid, Table2 } from "lucide-react";
...
export default function ColorsClient() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const allDataRes = await getAll<ColorWithId>("/colors", {
          limit: "1000", 
