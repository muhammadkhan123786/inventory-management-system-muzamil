...
interface Props {
  data: (IContract & { _id: string; isActive?: boolean; isDefault?: boolean })[];
  displayView: "table" | "card";
  onEdit: (item: IContract & { _id: string; isActive?: boolean; isDefault?: boolean }) => void;
...
const ContractTypeTable = ({ data, displayView, onEdit, onDelete, onStatusChange, themeColor }: Props) => {
  // Card View
  if (displayView === "card") {
    return (
