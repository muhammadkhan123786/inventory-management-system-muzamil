          ...
          <div className="hidden md:flex flex-col justify-center md:w-1/2 p-8 lg:p-12  min-h-[600px] bg-linear-to-br from-gray-50 to-gray-100">
            ...
            <div>
              ...
              <h2 className="text-xl text-gray-600 font-medium mb-6">
                Simplify Stock. Amplify Growth{" "}
              </h2>
              {/* Paragraph Description */}
              <p className="text-gray-600 text-sm leading-relaxed mb-12">
                Real-Time Inventory. Anywhere, Anytime.
              </p>
            </div>
            {/* Features Section */}
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 rounded-2xl bg-white/50 px-4 h-16 shadow-md">
                ...
                <p className="text-base text-gray-700 font-bold">
                 Automate Your Stock. Accelerate Your Business
                </p>
              </div>
              {/* Feature 2 */}
              <div className="flex items-center gap-3 rounded-2xl bg-white/50 px-4 h-16 shadow-md">
...
From Stockroom to Cloud — Manage Everything.                </p>
              </div>
              {/* Feature 3 */}
              <div className="flex items-center gap-3 rounded-2xl bg-white/50 px-4 h-16 shadow-md">
                {/* Icon */}
                ...
                {/* Text */}
                <p className="text-base text-gray-700 font-bold">
Inventory Hub — Real-Time Inventory. Anywhere, Anytime.                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative lg:w-1/2 p-8 lg:p-8 lg:pt-10 flex flex-col justify-center shadow-2xl shadow-black/20">
            ...
            <div className=" w-full">
              <div className="text-left mb-8">
                <h2 className="text-2xl font-normal leading-8 text-indigo-950 mb-2">
                  Welcome Back
                </h2>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-xs text-blue-700 leading-relaxed">
                        Click any demo account above to quickly sign in and
                        explore the system.
                      </p>
                    </div>
                  </div>
